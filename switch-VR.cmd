...
rem powershell -Command "$s=New-Object -ComObject Shell.Application; $s.ShellExecute('C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Steam\Steam.lnk','','','open',1)"
goto end
...
ipconfig -flushdns
rem start "" "C:\Users\Ahmadsyar\local-software\ALVR\ALVR Launcher.lnk"
rem powershell -Command "$s=New-Object -ComObject Shell.Application; $s.ShellExecute('C:\Users\Ahmadsyar\local-software\ALVR\ALVR Launcher.lnk','','','open',1)"
goto end
:end
exit