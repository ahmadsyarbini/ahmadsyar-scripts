...
rem this is my script of installing and setting up settings and everything on newly reformatted pc

rem go to current directory
cd /d "%~dp0"
rem Run PowerShell script
powershell -ExecutionPolicy Bypass -File "sc-custom-region-ps1.ps1"

rem Apply sound scheme
reg import "reg-sound-my-scheme.reg"
...
call script-wterminal-settings.cmd