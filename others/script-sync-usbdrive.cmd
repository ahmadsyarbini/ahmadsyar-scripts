...
set "this_script=%userprofile%\My Drive\Documents\Tech\others\script-sync-usbdrive.cmd"
...
cd "%~dp0."
if exist "%~dp0script-sync-usbdrive.cmd" (
	robocopy "%automata_path%\others" "%~dp0." "script-sync-usbdrive.cmd" /z /R:1 /W:1 /NDL /NJH /NJS /NS /NFL
)
